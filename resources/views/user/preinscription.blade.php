...
<body class="bg-gray-900">
    ...
    <div class="pt-24">
        ...
        <form action="{{ route('dashboard') }}" method="POST"
            ...
            <div class="mb-4">
                <label for="date-and-place-of-birth" class="block text-gray-700 text-sm font-bold mb-2">Date et Lieu de
                    Naissance :</label>
                <input type="date" name="date-and-place-of-birth" id="date-and-place-of-birth" autocomplete="off"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                <input type="text" name="place of birth" id="place-of-birth" autocomplete="off"
                    placeholder="Lieu de Naissance"
                    class="w-full mt-2 px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" autocomplete="off" placeholder="nom@gmail.com"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="telephone" id="telephone" autocomplete="off"
                    placeholder="Nom +237 _ __ __ __ __"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <fieldset class="mb-4">
                ...
                <div class="flex items-center mb-2">
                    <input type="radio" name="sex" value="Masculin" id="sex-masculin"
                        class="form-radio text-blue-600 focus:ring-blue-500">
                    <label for="sex-masculin" class="ml-2 text-gray-700 text-sm">Masculin</label>
                </div>
                <div class="flex items-center">
                    <input type="radio" name="sex" value="Féminin" id="sex-feminin"
                        class="form-radio text-blue-600 focus:ring-blue-500">
            ...
            <div class="mt-6 items-center justify-center flex">
                <a class="" href="{{ route('home') }}">Envoyer</a>
                <button type="submit"
                    class="w-auto bg-blue-500 text-white py-2 px-4 rounded-lg shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Envoyer</button>
            </div>
        </form>
