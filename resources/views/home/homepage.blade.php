...
<div class="flex-col w-full bg-gray-100 md:flex md:flex-row md:min-h-screen bg-gradient-to-l from-slate-900 to-slate-700 -z-30 bg-transparent">
    ...
    <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
      ...
      <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
        <a class="flex  gap-3 px-4 py-2 mt-2 text-sm font-semibold text-gray-900 transition-colors duration-300 bg-gray-200 rounded-lg dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-300 focus:bg-gray-300 focus:outline-none focus:shadow-outline" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="flex justify-between gap-4 size-6">
        ...
        {{-- <a class="flex block gap-3 px-4 py-2 mt-2 text-sm font-semibold text-gray-900 transition-colors duration-300 bg-transparent rounded-lg dark:bg-transparent dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <div class="flex-1">
        ...
        <!-- Main Content -->
            <header class="fixed flex items-center justify-between w-4/6 px-6 py-5 mt-1 ml-10 mr-6 overflow-hidden rounded-md bg-gradient-to-t from-sky-400 to-sky-100 text-sky-800">
...
{{-- *********** --}}
            ...
            <div class=" py-20 mx-6 ml-6 bg-black text-center text-white rounded-sm shadow-md mt-28 bg-custom shadow-black">
            ...
            <h2 class="py-7 mb-4 text-2xl font-bold text-center text-transparent bg-gradient-to-tr from-sky-500 to-sky-400 bg-clip-text">Books currently available</h2>

            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 w- 1/3 shadow-md shadow-black py-7 px-4">
            
                @foreach ($livre as $livre)
                    <div  class="flex flex-col ml-5 overflow-hidden bg-white rounded-lg shadow-md w-72 lg:flex-row shadow-slate-700">

                        <img class="object-cover w-full pt-2 pl-3 rounded-sm h-36 lg:w-1/3 sm:w-1/3 sm:rounded-md" src="/storage/{{ $livre->book_img }}" alt="{{ $livre->title }}"> 
            ...
            <h2 class="py-5 mb-4 text-2xl font-bold text-center text-transparent bg-gradient-to-tr from-sky-500 to-sky-400 bg-clip-text">Browse Through Some Categories</h2>
            ...
            <div class="container p-6 mx-auto my-4 bg-black bg-opacity-50 rounded-md">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                    ...
                    <a href="/arts" class="transition-transform transform hover:scale-105">
                        <div class="flex items-center justify-center w-full text-center text-white rounded-lg shadow-lg bg-gradient-to-r from-gray-400 to-gray-600 h-28 category-card">
                            <h3 class="text-lg font-bold">Arts</h3>
                        </div>
                    </a>
                    <a href="/gestion" class="transition-transform transform hover:scale-105">
                        <div class="flex items-center justify-center w-full text-center text-white rounded-lg shadow-lg bg-gradient-to-r from-teal-400 to-teal-600 h-28 category-card">
                            <h3 class="text-lg font-bold">Gestion</h3>
                        </div>
                    </a>
                    <a href="/tourisme" class="transition-transform transform hover:scale-105">
                        <div class="flex items-center justify-center w-full text-center text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-400 to-blue-600 h-28 category-card">
                            <h3 class="text-lg font-bold">Tourisme</h3>
                        </div>
                    </a>
                    <a href="/elevage" class="transition-transform transform hover:scale-105">
                        <div class="flex justify-center w-full text-white rounded-lg shadow-lg items-jcenter text-ceter bg-gradient-to-r from-orange-400 to-orange-600 h-28 category-card">
                            <h3 class="text-lg font-bold">Elevage</h3>
                        </div>
                    </a>
                    <a href="/genie-info" class="transition-transform transform hover:scale-105">
                        <div class="flex items-center justify-center w-full text-center text-white rounded-lg shadow-lg bg-gradient-to-r from-purple-400 to-purple-600 h-28 category-card">
...
<body class="bg-gray-100">
    ...
    <!-- Main content -->
    <main class="p-4">
        <p class="text-center text-gray-700 text-sm">Explore a vast collection of eBooks and much more.</p>
    </main>
