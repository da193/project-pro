    ...
    <div class="p">
        ...
        <div class="flex-col w-full fixed md:flex md:flex-row md:min-h-screen bg-yellow-500 -z-30 bg-transparent">
            ...
            <div class="flex-1 bg-slate-500 ">
                ...
                <h2
                    class="mb-4 text-2xl  bg-white text-center bg-opacity-60 font-bold py-6 shadow-black shadow-md ml-4 mr-4 rounded-md ">
                                ...
                                <div class="flex-1 p-4 flex flex-col justify-between">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('details', ['id' => $livre->id]) }}"
                                           class="inline-block px-4 py-2 text-sm text-white bg-yellow-400 rounded-lg hover:bg-yellow-500 transition hover:text-red-600 font-bold shadow-red-700">Plus de détails</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
