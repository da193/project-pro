...
<body class="bg-gradient-to-r from-slate-900 to-slate-700">
    ...
    <div class="p">
        ...
        <div class="flex-col w-full fixed md:flex md:flex-row md:min-h-screen bg-yellow-500 -z-30 bg-transparent">
            ...
            <div class="flex-1 bg-slate-500 ">
                ...
                <h2
                    class="mb-4 text-2xl  bg-slate-700 text-center text-yellow-500 font-bold py-6 shadow-black shadow-md ml-4 mr-4 rounded-md ">
                    Livres Disponible</h2>

                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2 pt-5">
                    @foreach ($livre as $livre)
                        <div
                            class="flex flex-col overflow-hidden bg-white rounded-lg shadow-md w-72 lg:flex-row shadow-slate-700 ml-8">
                            <img class="object-cover w-2/4 pt-2 pl-3 rounded-sm h-36 lg:w-1/3"
