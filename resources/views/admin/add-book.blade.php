    ...
    <main class="flex items-center justify-center w-full max-w-lg p-4 mt-4">
        <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg shadow-slate-900">
            <form  action="{{ route('book.register') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="title" class="block mb-2 text-lg font-semibold text-gray-700">Titre :</label>
                ...
                <div class="mb-4">
                    <label for="category" class="block mb-2 text-lg font-semibold text-gray-700">Catégorie :</label>
                ...
                <div class="mb-4">
                    <label for="author" class="block mb-2 text-lg font-semibold text-gray-700">Auteur :</label>
                ...
                <div class="mb-4">
                    <label for="biography" class="block mb-2 text-lg font-semibold text-gray-700">Biographie :</label>
                ...
                <div class="mb-4">
                    <label for="thumbnails" class="block mb-2 text-lg font-semibold text-gray-700">Image du Livre:</label>
                ...
                <div class="mb-4">
                    <label for="thumbnails" class="block mb-2 text-lg font-semibold text-gray-700">Contenu du livre :</label>
                    {{-- <input type="file" name="book_img" id="thumbnails" class="w-full p-3 text-gray-700 border border-gray-300 rounded-md file:border-0 file:bg-purple-600 file:text-white file:rounded-md file:p-2 hover:file:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500"> --}}
                    <input type="file" id="file_path" name="file_path" class="w-full p-2 border rounded" accept=".pdf,.epub,.txt" required>
                    @error('thumbnails')
                        <div class="mt-2 text-sm text-red-500">{{ $message }}</div>
                    @enderror
                </div>
