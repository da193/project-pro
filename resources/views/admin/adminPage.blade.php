...
<div class="flex-col w-full bg-gray-100 md:flex md:flex-row md:min-h-screen dark:bg-gray-900">
    ...
    <!-- Main Content -->
        ...
        <div class="container p-6 mx-auto">
            <h2 class="mb-4 text-2xl font-bold text-center text-transparent py-7 bg-gradient-to-tr from-sky-500 to-sky-400 bg-clip-text">Books currently available</h2>
