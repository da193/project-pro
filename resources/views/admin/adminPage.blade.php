...
<div class="flex-col w-full bg-gray-100 md:flex md:flex-row md:min-h-screen dark:bg-gray-900">
    ...
    <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
      ...
      <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4 shadow-md bg-gray-50 dark:bg-gray-900 shadow-black mb-2">
      ...
      <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
        ...
        <a class=" flex gap-3 px-4 py-2 mt-2 text-sm font-semibold text-gray-900 transition-colors duration-300 bg-transparent rounded-lg dark:bg-transparent dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"href="{{ route('category_page') }}">
            ...
            Categories</a>
        <a class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 transition-colors duration-300 bg-transparent rounded-lg dark:bg-transparent dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">Auteurs</a>
    ...
    <!-- Main Content -->
        ...
        <div class="relative py-20 mx-6 mt-5 ml-6 text-center text-white rounded-md shadow-md bg-custom ">
            ...
            <div class="relative z-10 max-w-6xl px-6 mx-auto r  ounded-lg">
        ...
        <div class="container p-6 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 w- 1/3 shadow-black shadow-md px-4 py-7">
                ...
                @foreach ($livre as $livre)
                    <div class="flex flex-col overflow-hidden bg-white rounded-lg shadow-md w-72 lg:flex-row shadow-slate-700">
                        <img class="object-cover w-fit pt-2 pl-3 rounded-sm h-36 lg:w-1/3" src="/storage/{{ $livre->book_img }}" alt="{{ $livre->title }}"> 
        ...
        <h2 class="py-7 mb-4 text-2xl font-bold text-center text-transparent bg-gradient-to-tr from-sky-500 to-sky-400 bg-clip-text">category currently available</h2>
