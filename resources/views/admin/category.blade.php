...
<div class="flex-col w-full bg-gray-100 md:flex md:flex-row md:min-h-screen dark:bg-gray-400">
    ...
    <header class="fixed overflow-hidden w-5/6 ml-2 mr-6 p-6 a text-2xl font-bold text-center text-white bg-gradient-to-r from-blue-500 to-purple-600 rounded-md shadow-md shadow-slate-950">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50 mt-2">
                            ...
                            <td class="py-4 text-center">
                                <a class="w-full px-4 py-2 text-sm font-medium text-white bg-red-500 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-red-500" href="{{ route('cat_delete', $livre->id) }}">Delete</a>
                                <a class="w-full px-4 py-2 text-sm font-medium text-white bg-gradient-to-t from-teal-600 to-teal-400 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-teal-500" href="{{ route('edit_cat', $livre->id) }}">Update</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
